...
در تنها خط ورودی کلمات مورد جستجو که با یک فاصله از هم جدا شده‌اند می‌آیند. هریک از این کلمات می‌تواند شامل یکی از عملگرهای + یا - به ترتیب برای مشخص کردن کلمات مطلوب یا نامطلوب باشد.
    
0 ≤ number of words ≤10
0 < word length ≤ 20

  ## **خروجی**

خروجی شامل شامل n+1 خط است که n تعداد اسناد متمایز منطبق با پرس‌و‌وجو می‌باشد؛ در خط اول عدد n می‌آید و در n خط بعدی نام اسناد به ترتیب صعودی قرار می‌گیرد. در صورت بروز خطا کافی‌ست متن خطای موردنظر نمایش داده شود.
